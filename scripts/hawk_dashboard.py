...
_PORTFOLIO_DEFAULTS = {
    ...
    "conservative_vol": ("logs/hawk_state_conservative_vol.json", "logs/hawk_trades_conservative_vol.csv", 5001),
    "optimal":          ("logs/hawk_state_optimal.json",          "logs/hawk_trades_optimal.csv",          5002),
    "optimal_vol":      ("logs/hawk_state_optimal_vol.json",      "logs/hawk_trades_optimal_vol.csv",      5003),
}
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Portfolio shortcuts (auto-fills state/trades/port):
